...
- El acceso a Hemis debe ser inmediato y reconocible en cualquier momento de la partida.
...
Su función es informar de forma inmediata cuántas veces puede curarse el jugador antes de llegar al siguiente pilar solar. Como este recurso opera bajo una lógica limitada y se recarga en Pilares solares, su visibilidad es importante para la toma de decisiones durante la exploración y especialmente durante el combate.
...
- Reflejar la recarga completa al descansar en un pilar solar.
...
## Botón de acceso a Hemis

En la **parte inferior derecha** de la pantalla debe existir siempre un botón con forma de **hexágono dorado**, que representa el acceso directo a **Hemis**. Este botón funciona como uno de los elementos más importantes del HUD, ya que garantiza que el jugador pueda pedir ayuda en cualquier momento de la partida.

![Logo SVG de referencia para Hemis](@assets/svgs/arte-conceptual/Hemis.svg)

La identidad visual del acceso a Hemis debe apoyarse en un **logo en formato SVG** para conservar nitidez, escalabilidad y consistencia en distintas resoluciones de pantalla.

Su función principal es desplegar la interfaz de conversación con Hemis al hacer clic sobre él. Esta aparición debe sentirse similar a la intervención de un acompañante dentro del juego, como una presencia constante que asiste al jugador sin romper la lógica del mundo. La referencia conceptual es una ayuda persistente tipo acompañante, pero reforzada por el uso de un modelo de lenguaje natural.

El botón de Hemis debe cumplir las siguientes condiciones:
...
## Interfaz emergente de Hemis

Al activarse el botón de Hemis, debe abrirse una ventana o panel de conversación superpuesto a la experiencia actual. Esta interfaz debe sentirse como un diálogo contextual dentro del mundo, no como una pantalla ajena al juego.

La interfaz de Hemis debe permitir:
...
## Panel de chat con Hemis dentro del editor

Debajo del panel de código, dentro de la misma columna lateral, se ubica el **chat de Hemis**. Esta sección funciona como apoyo directo durante el proceso de creación de munición, permitiendo que el jugador consulte dudas sin salir de la interfaz de edición.
...
El juego distingue entre un **HUD base**, visible durante la exploración y el combate, y un **HUD expandido**, que aparece en contextos específicos como la creación de munición o la conversación extendida con Hemis. Esta distinción es importante para conservar la limpieza visual durante la partida normal y, al mismo tiempo, ofrecer herramientas más complejas cuando el jugador realmente las necesita.
...
- Ventana de conversación con Hemis
- Interfaz de creación de munición
